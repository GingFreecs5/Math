...
\begin{document}
	...
	\paragraph{Exemple :} Pour \( f(x) = x^2 - 4x + 4 \) sur \([0, 4]\), on trouve un point \( c = 2 \) tel que \( f'(2) = 0 \).
	...
	\paragraph{Exemple :} Soit la fonction \( f(x) = x^2 \) définie sur l'intervalle \( [1, 3] \).
